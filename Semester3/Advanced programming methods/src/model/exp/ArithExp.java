...
public class ArithExp implements Exp {
    ...
    public Value eval(MyIDictionary<String,Value>symbols_table, MyIHeap<Integer,Value> heap_table)throws MyException{
        ...
        evaluation_1 = expression_1.eval(symbols_table, heap_table);
        if(evaluation_1.getType().equals(new IntType())){
            evaluation_2 = expression_2.eval(symbols_table, heap_table);
    ...
    public Type typeCheck(MyIDictionary<String,Type>typeEnv)throws MyException{
            ...
            if(tp1.equals(new IntType())){
                if(tp2.equals(new IntType())) {
                    return new IntType();
                }else throw new MyException("The second operand is not of type integer");
            }else throw new MyException("The first operand is not of type integer");
