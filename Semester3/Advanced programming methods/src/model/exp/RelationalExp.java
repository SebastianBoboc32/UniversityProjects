...
public class RelationalExp implements Exp{
    ...
    public Value eval(MyIDictionary<String, Value>SymbolsTable, MyIHeap<Integer,Value> heap_table)throws MyException {
        BoolValue return_value = new BoolValue(false);
        Value evaluation_1 = expression_1.eval(SymbolsTable, heap_table);
        if(evaluation_1.getType().equals( new IntType())){
            Value evaluation_2 = expression_2.eval(SymbolsTable, heap_table);
